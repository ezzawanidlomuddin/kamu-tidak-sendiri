...
function reverseGeocode(lat, lon) {
    ...
    const apiKey = "bdc_2e9bd20388eb4b0b8884bbc02299d7f6";
    const url = `https://api.bigdatacloud.net/data/reverse-geocoding?latitude=${lat}&longitude=${lon}&localityLanguage=id&key=${apiKey}`;
